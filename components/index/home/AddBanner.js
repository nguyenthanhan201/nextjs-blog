...
const DynamicModal = dynamic(() => import("./ModalAddBanner"), { ssr: false });

const AddBanner = ({ setData, data, img }) => {
  // console.log("👌 ~ img", img);
  ...
  return (
    <div className="w-full backdrop-blur-sm bg-white/30 h-[445px] flex items-center justify-center gap-4 add-banner overflow-hidden">
      {img ? (
        <>
          <img src={img} alt="img" />
        </>
        ...
        <>
          ...
          <p className="text-[#14597A] cursor-pointer" onClick={handleOpen}>
            Add a banner
          </p>
        </>
      )}
